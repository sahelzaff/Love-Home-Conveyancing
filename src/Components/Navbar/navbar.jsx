...
const Navbar = () => {
    ...
    useEffect(() => {
        const handleScroll = () => {
            ...
            setIsNavbarFixed(scrollPosition > 300);
        };
    ...
    return (
        <div
            className={`navbar ${logoVisible ? "reveal" : ""} ${isNavbarFixed ? "fixed" : ""}`}
        ...
        >
            ...
            <ul className="navbar-menu">
                ...
                >
                    ...
                    <img
                        src={assets.arrow}
                        className={`arrow ${servicesDropdownVisible ? "down" : "up"}`}
                        alt="Arrow"
                    />
                ...
                >
                    ...
                    <img
                        src={assets.arrow}
                        className={`arrow ${aboutDropdownVisible ? "down" : "up"}`}
                        alt="Arrow"
                    />
